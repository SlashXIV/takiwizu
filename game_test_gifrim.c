...
bool testv2_has_error_unique() {
  ...
  game g3 = game_new_empty_ext(4, 6, false, true);
  ...
  game_set_square(g3, 1, 3, S_ONE);
  game_set_square(g3, 1, 4, S_ZERO);
  game_set_square(g3, 1, 5, S_ZERO);

  game_set_square(g3, 2, 0, S_ONE);
  game_set_square(g3, 2, 1, S_ONE);
  game_set_square(g3, 2, 2, S_ZERO);
  game_set_square(g3, 2, 3, S_ZERO);
  game_set_square(g3, 2, 4, S_ONE);
  game_set_square(g3, 2, 5, S_ONE);

  game_set_square(g3, 3, 0, S_ZERO);
  ...
  if (game_is_over(g3)) return false;
